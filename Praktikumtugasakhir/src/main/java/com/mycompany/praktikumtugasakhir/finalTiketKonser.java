...
public class finalTiketKonser {
    ...
    static void checkKuota (){
        Scanner in = new Scanner(System.in);
        int [] maxKuota = {150, 150, 90, 60};
        int jumlahKursi = 0;
        String input="";
        System.out.println("                       Check Kuota Kursi FUNFEST.ID");
        System.out.println("!!! Masukan golongan tiket sesuai dengan kriteria penulisan golongan tiket !!!");
        System.out.println("""
                                                            Golongan Tiket
                           VVIP
                           VIP
                           Reguler
                           Crowd""");
        System.out.print("Masukan Golongan Tiket(masukkan sesuai menu): ");
        input = in.nextLine();
        System.out.print(input+" tersisa ");
        if (input.equalsIgnoreCase("Crowd")) {
            System.out.println(jumlahKursi+"/"+maxKuota[0]+" kursi.");
        } else if (input.equalsIgnoreCase("Reguler")) {
            System.out.println(jumlahKursi+"/"+maxKuota[1]+" kursi.");
        } else if (input.equalsIgnoreCase("VIP")) {
            System.out.println(jumlahKursi+"/"+maxKuota[2]+" kursi.");
        } else if (input.equalsIgnoreCase("VVIP")) {
            System.out.println(jumlahKursi+"/"+maxKuota[3]+" kursi.");
        }
        System.out.println();
    }
    ...
    public static void signUp(){
        ...
        if (!databaseUser.containsKey(newEmail)) {
            ...
            System.out.println("Sign Up berhasil. Silahkan login dengan username baru ");
        } else {
